...
const ContributePageContent: React.FC = () => {
  ...
  return (
    <main className="max-w-5xl mx-auto md:pt-5 transition-colors duration-200 flex flex-col items-stretch gap-10 px-5 lg:px-0 overflow-x-hidden lg:overflow-y-hidden">
      <Header
        searchTerm=""
        setSearchTerm={(value) =>
        ...
        <div className="prose dark:prose-invert prose-neutral">
          ...
          <ol>
            ...
            <li>
              ...
              <a
                href="https://github.com/mohitrajcoderf/developer-docs-gallery/blob/main/src/components/ToolsPageContent.tsx"
                target="_Blank"
                rel="noopener"
              >
            ...
            <li>
              <span>Support Us:</span> Please go to GitHub and give a star to
              our project, it helps us to bring more such projects.
            </li>
          </ol>
          <p>
